...
<div class="col-md-10">
<a href="mailto:navazsmart24@gmail.com" style="color:#000000">gundloorunavaz201810@gmail</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/Navaz.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<h4 style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">GUNDLOORU NAVAZ</h4>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9391184702</h4>
		<h4 style="font-family:'typo' ">gundloorunavaz201810@gmail.com</h4>
		<h4 style="font-family:'typo' ">Annamacharya Institute Of Technology And Sciences,Tirupati</h4></div></div>
		</p>
      </div>
